...
public final class Order {
    ...
    public Order(OrderBuilder builder) {
        ...
        this.lines = Collections.unmodifiableList(builder.lines); // builder.lines;
    ...
    public List<OrderLine> getLines() { return Collections.unmodifiableList(lines); } // leaks internal list
    ...
    public static class OrderBuilder{
        ...
        public OrderBuilder(String id, String customerEmail, List<OrderLine> lines) {
            ...
            this.lines = new ArrayList<>(lines); // copy addAll(lines);
        }
        ...
        public Order build() {
            ...
            if (discountPercent != null && !PricingRules.isValidDiscount(discountPercent)) {
        ...
        public OrderBuilder addLine(OrderLine line) { lines.add(line); return this;}
        public OrderBuilder setDiscountPercent(Integer discountPercent) { 
            this.discountPercent = discountPercent; 
            return this;
        }
        public OrderBuilder setExpedited(boolean expedited) { this.expedited = expedited; return this;}
        public OrderBuilder setNotes(String notes) { this.notes = notes; return this;}
    }
}
